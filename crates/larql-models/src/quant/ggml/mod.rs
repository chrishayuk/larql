...
mod tests {
    ...
    const Q6K_GT_BYTES: [u8; 210] = [
        200, 200, 8, 0, 0, 128, 200, 4, 192, 4, 200, 204, 140, 140, 0, 8,
        133, 1, 6, 138, 11, 139, 134, 11, 6, 10, 0, 5, 10, 10, 6, 128,
        193, 203, 138, 6, 139, 203, 203, 10, 79, 197, 139, 129, 197, 70, 128, 198,
        4, 192, 20, 56, 8, 68, 52, 76, 204, 208, 12, 156, 172, 192, 192, 68,
        118, 65, 127, 22, 198, 223, 106, 65, 69, 150, 198, 69, 251, 193, 219, 122,
        92, 232, 112, 236, 112, 4, 236, 180, 176, 180, 176, 176, 148, 84, 156, 8,
        3, 31, 243, 7, 9, 13, 13, 0, 252, 3, 7, 4, 3, 12, 252, 1,
        198, 68, 12, 4, 129, 7, 64, 128, 193, 70, 196, 6, 192, 15, 70, 4,
        82, 84, 142, 161, 165, 87, 100, 42, 219, 126, 102, 150, 105, 150, 40, 166,
        166, 96, 21, 82, 169, 149, 88, 188, 113, 135, 145, 162, 23, 106, 104, 171,
        213, 32, 214, 133, 217, 107, 187, 105, 230, 164, 84, 106, 116, 148, 229, 146,
        109, 171, 214, 9, 158, 134, 139, 91, 81, 157, 89, 144, 106, 174, 129, 137,
        222, 26, 31, 216, 175, 41, 178, 71, 33, 213, 33, 223, 33, 224, 33, 128,
        120, 129,
    ];
    #[rustfmt::skip]
    ...
    const Q40_GT_BYTES: [u8; 18] = [
        0, 154, 41, 7, 134, 135, 147, 165, 185, 169, 135, 217, 170, 152, 41, 115,
        39, 137,
    ];
    #[rustfmt::skip]
