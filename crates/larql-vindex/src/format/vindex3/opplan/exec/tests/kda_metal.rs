...
impl DeviceWeights {
    ...
    fn refs<'a>(&'a self, fx: &'a Fixture) -> KdaDeviceWeights<'a> {
        KdaDeviceWeights {
            ...
            k_conv1d: &fx.kc,
            v_conv1d: &fx.vc,
            f_a_proj: larql_compute_metal::trait_impl::kda::SmallMatrix::F32(&fx.fa),
            f_b_proj: larql_compute_metal::trait_impl::kda::SmallMatrix::F32(&fx.fb),
            g_a_proj: larql_compute_metal::trait_impl::kda::SmallMatrix::F32(&fx.ga),

            g_b_proj: larql_compute_metal::trait_impl::kda::SmallMatrix::F32(&fx.gb),
            b_proj: larql_compute_metal::trait_impl::kda::SmallMatrix::F32(&fx.bp),
            a_log: &fx.al,
            dt_bias: &fx.dt,
            o_norm: &fx.on,
            norm_eps: fx.eps,
