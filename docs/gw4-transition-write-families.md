...
[`output/gw4a-gemma3-4b-it-phase1/report.json`](../output/gw4a-gemma3-4b-it-phase1/report.json),
with SHA-256
...
The final report is
[`output/gw4b-gemma3-4b-it-phase1/report-final.json`](../output/gw4b-gemma3-4b-it-phase1/report-final.json),
with SHA-256
